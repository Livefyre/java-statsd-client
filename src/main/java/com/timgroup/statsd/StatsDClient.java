...
/**
 * Describes a client connection to a StatsD server, which may be used to post
 * metrics in the form of counters, timers, and gauges.
 * 
 * <p>
 * Three key methods are provided for the submission of data-points for the
 * application under scrutiny:
 * <ul>
 * <li>{@link #incrementCounter} - adds one to the value of the specified named
 * counter</li>
 * <li>{@link #recordGaugeValue} - records the latest fixed value for the
 * specified named gauge</li>
 * <li>{@link #recordExecutionTime} - records an execution time in milliseconds
 * for the specified named operation</li>
 * </ul>
 * 
 * @author Tom Denley
 * 
...
public interface StatsDClient {
	...
	/**
	 * Cleanly shut down this StatsD client. This method may throw an exception
	...
	/**
	 * Increments the specified counter by n, but limits data flow to the
	 * specified rate.
	 * 
	 * <p>
	 * This method is non-blocking and is guaranteed not to throw an exception.
	 ...
	 * @param rate
	 *            a value between 0.0 and 1.0 which indicates the sampling rate
	 *            in terms of a percentage of the total times this method is
	 *            called. E.g. a rate of 0.1 will send data to StatsD 1/10th of
	 *            the time.
	 */
	 ...
	 * {@link #addSetElements(String, String...)}.
	 */
	...
	/**
	 * Convenience method equivalent to
	 * {@link #recordExecutionTime(String, int)}.
	 */
